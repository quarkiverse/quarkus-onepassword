...
class ConfigIntegrationTest {
    ...
    @Test
    void resolvesExpressionsAndConfigMappings() throws Exception {
    ...
    @Test
    void unusedAndOverriddenReferencesNeverExecuteCli() {
    ...
    @Test
    void runtimeBuilderRegistersHandler() throws Exception {
